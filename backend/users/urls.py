...
from users.views import UserRegestrationView, UserLoginView, UserProfileView, FollowUnfollow, UserChangePasswordView, SendPasswordResetEmailView, UserPasswordResetView, SuggestionsView
